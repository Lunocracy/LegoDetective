class GameController {
  ...
  createNewPair() {
    ...
    this.ui.setMessage('Building next puzzle...', 0);
    ...
    if (clickedRecId === this.diffInfo.recId) {
      ...
      if (targetWasHit) {
        ...
        setTimeout(() => {
          if (bonus > 0) {
            this.score += bonus;
            this.ui.setMessage(`Chain Reaction! +${bonus} bonus points!`, 2500);
          } else {
            ...
            this.ui.setMessage(message, 2500);
          }
          this.ui.setScore(this.score);
        }, 400);
      }
  ...
  revealDifference() {
    ...
    if (this.cheatCount === 1) {
      ...
      this.score -= penalty;
      this.ui.setScore(this.score);
      this.ui.setMessage(`Cheat 1: Target color preview on button! -${penalty} pt.`, 2500);
      ...
      this.score -= penalty;
      this.ui.setScore(this.score);
      this.ui.setMessage(`Cheat 2: Target piece size shown on button! -${penalty} pt.`, 3000);
  ...
  _buildAndFinalizePair() {
    ...
    this.ui.enableAllButtons(true);
    this.ui.enableReveal(true);
    this.ui.setMessage('Find and click the one different brick.', 3500);
  }
...
if (typeof module !== 'undefined' && module.exports) module.exports = GameController;